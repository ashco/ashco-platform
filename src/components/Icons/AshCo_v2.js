...
const AshCo = ({ theme }) => {
  ...
  return (
    <svg width="832" height="838" viewBox="0 0 832 838" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M416 0L370.406 86.4606L0.456787 788H85.808L416 161.852L746.192 788H831.543L461.594 86.4606L416 0Z" fill={colorText}/>
      ...
      <path d="M581.5 491C581.5 582.403 507.403 656.5 416 656.5C324.597 656.5 250.5 582.403 250.5 491C250.5 399.597 324.597 325.5 416 325.5C507.403 325.5 581.5 399.597 581.5 491Z" stroke={colorText} stroke-width="44"/>
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M369.949 86.4606L415.543 0L461.137 86.4606L563.198 280H477.847L415.543 161.852L353.239 280H267.888L369.949 86.4606Z" fill={colorText}/>
    </g>
    <defs>
